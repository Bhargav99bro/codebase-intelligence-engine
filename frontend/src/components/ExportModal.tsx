...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, analysisId }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-[2px] animate-in fade-in duration-150">
      <div className="relative w-full max-w-xl bg-white border border-slate-200 rounded-xl shadow-2xl p-6 overflow-hidden">
        {/* Modal Header */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-200">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Standard export formats for CI/CD, IDEs, and architectural reviews</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="py-5 space-y-3">
          {/* 1. SARIF v2.1.0 */}
          <div className="flex items-start justify-between p-4 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 transition">
            <div className="flex items-start space-x-3 pr-3">
              <FileCode className="w-5 h-5 text-indigo-600 shrink-0 mt-0.5" />
              <div>
                <h4 className="font-semibold text-sm text-slate-900">OASIS SARIF v2.1.0</h4>
            ...
            <a
              ...
              className="flex items-center px-3 py-1.5 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shrink-0 shadow-sm transition"
            >
          ...
          <div className="flex items-start justify-between p-4 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 transition">
            <div className="flex items-start space-x-3 pr-3">
              ...
              <div>
                <h4 className="font-semibold text-sm text-slate-900">Executive Markdown Audit Report</h4>
                <p className="text-xs text-slate-600 mt-0.5">
            ...
            <div className="flex items-center space-x-2 shrink-0">
              <button
                ...
                disabled={copying}
                className="flex items-center px-3 py-1.5 rounded-md bg-white hover:bg-slate-100 text-slate-700 text-xs font-medium border border-slate-300 shadow-sm transition"
              >
                {copied ? (
                  <>
          ...
          <div className="flex items-start justify-between p-4 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 transition">
            <div className="flex items-start space-x-3 pr-3">
              ...
              <div>
                <h4 className="font-semibold text-sm text-slate-900">Consolidated JSON Intelligence Payload</h4>
                <p className="text-xs text-slate-600 mt-0.5">
            ...
            <a
              ...
              className="flex items-center px-3 py-1.5 rounded-md bg-amber-600 hover:bg-amber-700 text-white text-xs font-semibold shrink-0 shadow-sm transition"
            >
              <Download className="w-3.5 h-3.5 mr-1.5" />
              .json
            </a>
        ...
        <div className="flex justify-end pt-3 border-t border-slate-200">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-md bg-white hover:bg-slate-50 border border-slate-300 text-slate-700 text-xs font-semibold shadow-sm transition"
          >
            Close
          </button>
        </div>
